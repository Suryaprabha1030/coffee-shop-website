...
const Navbar = () => {
  ...
  return (
    ...
    <div className='w-full  flex flex-row items-center justify-center fixed z-20'>
     <div className='max-w-full container mx-auto flex flex-row md:flex-row  justify-between md:justify-around items-center    md:bg-primary bg-sub'>
       ...
       <ul className={`w-full md:w-auto flex flex-col border-t-2 border-secondary md:border-t-0  md:flex-row items-center pl-9  md:mt-0 pb-5 md:pl-0 md:pb-0 md:justify-around gap-7 absolute  md:static bg-sub md:bg-primary md:z-auto z-[9]  ${show ? 'top-20':'top-[-490px]'}` }>
          ...
          <a href="#home"><li className=' text-card md:text-secondary text-lg md:text-xl  font-bold'>Home</li></a>
          <a href="#about"><li className='text-card md:text-secondary text-lg md:text-xl font-bold'>About</li></a>
          <a href="#services"><li className='text-card md:text-secondary text-lg md:text-xl font-bold'>Services</li></a>
          {/* <li className='text-card md:text-secondary text-xl font-bold'>Reservation</li> */}
          <a href="#reserve">< li className='text-card md:text-secondary text-lg md:text-xl font-bold'>Reviews</li></a>
